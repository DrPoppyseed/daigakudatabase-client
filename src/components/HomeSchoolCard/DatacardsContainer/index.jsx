        ...
        <div className={c.datacardContainer}>
          ...
          <div className={c.datacardBodyContainer}>
            ...
            admissions.sat.eng_25th_percentile === null ? (
              ...
              <React.Fragment>
                <Typography variant="caption">
                  入学者のACT点数の範囲： {admissions.act.comp_25th_percentile}
                  点 ~ {admissions.act.comp_75th_percentile}点
                </Typography>
                <Typography variant="caption">
                  入学者のSAT点数の範囲： {admissions.sat.total_25th_percentile}
                  点 ~{admissions.sat.total_75th_percentile}点
                </Typography>
              </React.Fragment>
            )}
          </div>
