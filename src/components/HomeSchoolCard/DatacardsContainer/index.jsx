      ...
      <div>
        <div className={c.datacardContainer}>
          ...
          <div className={c.datacardBodyContainer}>
            ...
            {
              admissions.population.applicants_total !== null && admissions.population.applicants_total !== '-' ? (
                <Typography variant='caption'>
                  合格率：{Math.floor(admissions.population.admitted_total / admissions.population.applicants_total * 100)}%
                </Typography>
              ) : (
